...
(
    ...
    `type`                int         not null comment '水库类型',
...
VALUES (1, 'S001', '电站一号', 1, 1, 1, 3, '500', 254.80, 121.72, '地址一', 267.00, 30.00),
       (2, 'P001', '电站二号', 2, 2, 2, 4, '650', 200.00, 80.23, '地址二', 244.00, 32.00),
       (3, 'S002', '电站十一号', 1, 1, 1, 3, '500', 254.80, 121.72, '地址三', 267.00, 30.00),
       (4, 'P002', '电站二二号', 3, 2, 2, 4, '650', 200.00, 80.23, '地址二', 244.00, 32.00),
       (5, 'P003', '电站三二号', 2, 2, 1, 4, '650', 200.00, 80.23, '地址二', 244.00, 32.00),
       (6, 'P004', '电站二十号', 3, 2, 2, 4, '650', 200.00, 80.23, '地址三', 244.00, 32.00),
       (7, 'P005', '电站二六号', 2, 1, 2, 4, '650', 200.00, 80.23, '地址二', 244.00, 32.00);
